    ...
    return (
        <section id="contact" className="contact">
            ...
            <form className="contact__form" onSubmit={handleSubmit}>
                <input type="text" name="name" placeholder="Full Name" onChange={updateInput} value={formData.name||''}/>
                <input type="email" name="email" placeholder="Email" onChange={updateInput} value={formData.email||''}/>
                <textarea type="text" placeholder="Message" name="message" onChange={updateInput} value={formData.message||''}></textarea>
